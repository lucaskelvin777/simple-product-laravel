...
class M2BRImagem
{
     ...
     * @return void
     */
    public function __construct($origem = '', $extensoes_validas = array(
        'jpg',
        'jpeg',
        'jpe',
        'gif',
     ...
     * @return Void
     */
    public function positionCrop($x, $y)
    {
     ...
     * @param String $tipo
     *            método para redimensionamento (padrão [vazio], 'fill' [preenchimento] ou 'crop')
     * @return Boolean/void
     */
    public function rescale($nova_largura = 0, $nova_altura = 0, $tipo = '')
    {
     ...
     *            grau para giro
     * @param Array $rgb
     *            cor RGB para preenchimento
     * @return void
     */
    public function girar($graus, $rgb = array(
        255,
        255,
        255
    ))
     ...
     * @return void
     */
    public function legenda($texto, $tamanho = 10, $x = 0, $y = 0, $rgb = array(
        255,
        255,
        255
     ...
     * @param Int $x
     *            posição x da marca na imagem
     * @param Int $y
     *            posição y da marca na imagem
     ...
     * @return void
     */
    public function store($destino = '', $qualidade = 100)
    {
